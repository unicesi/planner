 ...
 * @generated
 */
public class ApplicabilitymodelActionBarContributor extends EditingDomainActionBarContributor
	...
	protected IAction showPropertiesViewAction = new Action(
			ApplicabilityEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	...
	protected IAction refreshViewerAction = new Action(
			ApplicabilityEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				ApplicabilityEditorPlugin.INSTANCE.getString("_UI_ApplicabilitymodelEditor_menu"),
				"applicabilitymodelMenuID");
		...
		createChildMenuManager = new MenuManager(
				ApplicabilityEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(
				ApplicabilityEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));

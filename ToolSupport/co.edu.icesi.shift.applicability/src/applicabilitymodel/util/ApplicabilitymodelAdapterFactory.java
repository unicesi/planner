...
public class ApplicabilitymodelAdapterFactory extends AdapterFactoryImpl {
	...
	protected ApplicabilitymodelSwitch<Adapter> modelSwitch =
		new ApplicabilitymodelSwitch<Adapter>() {
			...
			@Override
			public Adapter caseRequiredVariant(RequiredVariant object) {
				return createRequiredVariantAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link applicabilitymodel.RequiredVariant <em>Required Variant</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

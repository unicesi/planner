 ...
 * </p>
 * <ul>
 *   <li>{@link applicabilitymodel.impl.InputModelImpl#getPath <em>Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InputModelImpl extends MinimalEObjectImpl.Container implements InputModel {
	...
	protected EClass eStaticClass() {
		return ApplicabilitymodelPackage.Literals.INPUT_MODEL;
	}
	...
	public void setPath(String newPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApplicabilitymodelPackage.INPUT_MODEL__PATH, oldPath, path));
	}

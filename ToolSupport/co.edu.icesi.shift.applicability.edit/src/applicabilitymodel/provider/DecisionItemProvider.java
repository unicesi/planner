...
/**
 * This is the item provider adapter for a {@link applicabilitymodel.Decision}
...
public class DecisionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Decision_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Decision_name_feature",
								"_UI_Decision_type"),
						ApplicabilitymodelPackage.Literals.DECISION__NAME, true, false, false,
	...
	protected void addComponentSetPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Decision_componentSet_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Decision_componentSet_feature",
								"_UI_Decision_type"),
						ApplicabilitymodelPackage.Literals.DECISION__COMPONENT_SET, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	/**
	 * This returns Decision.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ApplicabilitymodelPackage.Literals.DECISION__REQUIRED_VARIANTS,
